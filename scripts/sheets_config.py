...
#                      ADDED 2026-06-04 Session 13: 01_SAN_XUAT, 04_QLTB_CD
#                      ADDED 2026-06-04 Session 13: 03_QLCL, 05_KHO, 06_GSTT,
#                                                   07_CONG_NGHE_SPM, 08_BO_CONTROL
...
SHEET_CONFIG = {
    "01_SAN_XUAT": {
        ...
        # Full header: Ngay,Ca,Nha may,Lenh SX,May/DC,Nhom SP,SL KH,SL TT,SL Loi(NG),[9],RAG,...
    ...
    "03_QLCL": {
        ...
        # Full header: Ngay,Nha may,KH,Ma NCR,Nhom loi,Muc do,[6],Trang thai,PIC,...
    ...
    "04_QLTB_CD": {
        ...
        # GVIZ merged-cell fix: col0='' fallback_first_col; col4='' fallback_columns[4]
        # Full header: Ngay,Ca,Nha may,Ma may,[4],Loai dung may,...
    ...
    "06_GSTT": {
        ...
        # Full header: Check_Date,Shift,Site,Area,Category,Abnormality,Severity,Evidence_Link,Owner_Affected,[9],Status,...
    ...
    "07_CONG_NGHE_SPM": {
        ...
        # Full header: Ngay,Nha may,KH,Sample_ID,Nhom SP,PIC,[6],[7],Trang thai,[9],Redo_Count,Risk_Level,...
    ...
    "08_BO_CONTROL": {
        ...
        # Full header: Issue_Date,Source_Module,Site,Issue_Desc,Severity,Owner,PIC,Action_Required,[8],Status,...
